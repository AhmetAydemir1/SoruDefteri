...
class _InAppState extends State<InApp> {
  ...
  Future _getProduct() async {
    List<IAPItem> items =
        await FlutterInappPurchase.instance.getProducts(["consumable_id"]);
    for (var item in items) {
      print('${item.toString()}');
      print(item.subscriptionPeriodAndroid);
      print(item.subscriptionPeriodNumberIOS);
      print(item.subscriptionPeriodUnitIOS);
      print(item.introductoryPriceSubscriptionPeriodIOS);
